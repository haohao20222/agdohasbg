...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.Yo_Organize dal=new Maticsoft.DAL.Yo_Organize();
		public Yo_Organize()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.Yo_Organize GetModelByCache(int ID)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.Yo_Organize> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.Yo_Organize> DataTableToList(DataTable dt)
		{
